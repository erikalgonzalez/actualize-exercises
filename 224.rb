...
if 2 > 3          # 6 (2 is not greater than 3)
  ...
  w = 9           
elsif 2 == 2      # 9 (2 does equal 2)  
  x = 70          # 10 (v is 1, w is 2, x is 70, y is 4, z is 5)
  if 2 > 1        # 11 (2 is greater than 1)  
    y = 80        # 12 (v is 1, w is 2, x is 70, y is 80, z is 5) 
  else            
    z = 90        
  end             
  if x < 100      # 13 (x is less than 100) 
    w = 8         # 14 (v is 1, w is 8, x is 70, y is 80, z is 5)
    if z == 30    # 15 (z does not equal 30)
      y = 100     
    else          
      y = 14      # 16 (v is 1, w is 8, x is 70, y is 14, z is 5)
      if w > 10   # 17 (w is not greater than 10, end)
        v = 1000  
      end         
    end           
  else            
