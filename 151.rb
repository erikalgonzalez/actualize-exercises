...
def display_dogsarecool_screen   
    puts  "______   _______  _______  _______    _______  ______    _______    _______  _______  _______  ___"     
    puts "|      | |       ||       ||       |  |   _   ||    _ |  |       |  |       ||       ||       ||   |"    
    puts "|  _    ||   _   ||    ___||  _____|  |  |_|  ||   | ||  |    ___|  |       ||   _   ||   _   ||   |"    
    puts "| | |   ||  | |  ||   | __ | |_____   |       ||   |_||_ |   |___   |       ||  | |  ||  | |  ||   |"    
    puts "| |_|   ||  |_|  ||   ||  ||_____  |  |       ||    __  ||    ___|  |      _||  |_|  ||  |_|  ||   |___" 
